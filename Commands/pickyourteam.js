...
//         const Role1 = message.guild.roles.cache.find(role => role.name === "Instinct")
//         const Role2 = message.guild.roles.cache.find(role => role.name === "Mystic")
//         const Role3 = message.guild.roles.cache.find(role => role.name === "Valor")

//         const emoji1 = '👍';
//         const emoji2 = '👎';
//         const emoji3 = 'a:emoji_31:';
// //emoji_31
